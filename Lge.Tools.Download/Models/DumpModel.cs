...
{
    public class DumpModel : INotifyPropertyChanged, Models.ITabModel
    {
        ...
        #region ITabModel
        public Models.TabType TabId { get { return Models.TabType.Dump; } }
        ...
        public void TabActiveChanged(bool aActived)
        {
            if (aActived)
            {
                ...
                StatusMessage = "<Dump Downloading Mode>";
        ...
        {
            get { return false; } //Properties.Settings.Default.DAllErase; }
            set
            {
                // if (Properties.Settings.Default.DAllErase != value)
                {
                    // Properties.Settings.Default.DAllErase = value;
        ...
        public int LogLevel
        {
            get
            {
                return Properties.Settings.Default.DLogLevel;
            }
            set
            {
                if (Properties.Settings.Default.DLogLevel != value)
                {
                    Properties.Settings.Default.DLogLevel = value;
                    Log.LogLevel = value;
        ...
        {
            get { return _ECCCheck; }
            set
            {
                if (_ECCCheck != value)
                {
                    _ECCCheck = value;
                    ImageItem.ECCCheck = value;

                    InvokePropertyChanged(nameof(ECCCheck));
                }
            }
        }
        // jwoh add ECCCheck ]
        ...
        public Visibility DonlyVisible { get { return Visibility.Visible; } }
        public Visibility NonlyCollapsed { get { return Visibility.Collapsed; } } // jwoh add Micom Download only
